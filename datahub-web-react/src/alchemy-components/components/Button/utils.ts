...
const getButtonVariantStyles = (
    ...
    const primaryGradient = `radial-gradient(115.48% 144.44% at 50% -44.44%, ${theme?.styles?.['primary-color-gradient'] || '#FF3844'} 38.97%, ${theme?.styles?.['primary-color'] || '#ff161e'} 100%)`;
