...
const StyledMenuItem = styled(Menu.Item)<{ isCollapsed?: boolean }>`
    ...
    &.ant-menu-item-active {
        background: ${(props) => props.theme.colors?.bgHover || 'linear-gradient(180deg, rgba(243, 244, 246, 0.5) -3.99%, rgba(235, 236, 240, 0.5) 53.04%, rgba(235, 236, 240, 0.5) 100%)'};
    ...
    &&.ant-menu-item-selected {
        background: linear-gradient(
            180deg,
            rgba(255, 22, 30, 0.04) -3.99%,
            rgba(255, 56, 68, 0.04) 53.04%,
            rgba(255, 56, 68, 0.04) 100%
        );
        box-shadow: 0px 0px 0px 1px rgba(255, 22, 30, 0.08);
    }
`;
