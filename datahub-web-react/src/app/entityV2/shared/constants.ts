...
export const REDESIGN_COLORS = {
    ...
    GROUP_AVATAR_STYLE_GRADIENT: 'linear-gradient(0deg, #FF3844 0%, #ff161e 100%), #E61219',
    PROFILE_AVATAR_STYLE_GRADIENT: 'linear-gradient(93deg, #FF3844 5.11%, #ff161e 112.87%), #E61219',
